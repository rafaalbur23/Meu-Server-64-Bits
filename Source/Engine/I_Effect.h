...
public:
#ifdef USE_RENDER
	bool	CreateEffectFont(LERender*  pDev,
		CLEResManger	*pCResMagr,int iTexID,D3DXCOLOR dwColor, bool bUseBack = false,bool bmain =false);
#else
...
public:
	...
	//！初始化
#ifdef USE_RENDER
	virtual	void Init(LERender*	 pDev,EFFECT_TYPE  eType,
...
//class LIGHTENGINE_API CEffectBase
//{
//public:
//	CEffectBase(){}
//	~CEffectBase(){}
