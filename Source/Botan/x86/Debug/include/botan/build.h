...
* 'configure.py --cpu=x86_32 --cc=msvc --msvc-runtime=MDd --disable-shared-library --minimized-build --enable-modules=rsa,aes,block,utils,bcrypt,auto_rng,pubkey,x509,cbc'
*
* Target
