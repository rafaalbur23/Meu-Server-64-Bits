...
* 'configure.py --cpu=x86_64 --cc=msvc --msvc-runtime=MD --disable-shared-library --minimized-build --enable-modules=rsa,aes,block,utils,bcrypt,auto_rng,pubkey,x509,cbc'
*
* Target
