...
* 'configure.py --cpu=x86_64 --cc=msvc --msvc-runtime=MDd --disable-shared-library --minimized-build --enable-modules=rsa,aes,block,utils,bcrypt,auto_rng,pubkey,x509,cbc'
*
* Target
*  - Compiler: cl  /EHs /GR /MDd /bigobj /O2 /Oi
*  - Arch: x86_64
*  - OS: windows
*/
