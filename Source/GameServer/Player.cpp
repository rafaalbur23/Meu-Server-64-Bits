...
{T_B
	...
	m_CMapMask.AddMap("07xmas", 295, 295);
	m_CMapMask.AddMap("DreamIsland", 894, 894);
	m_CMapMask.AddMap("07xmas2", 295, 295);
	m_CMapMask.AddMap("abandonedcity", 383, 383);
	m_CMapMask.AddMap("abandonedcity2", 495, 495);
	m_CMapMask.AddMap("abandonedcity3", 495, 495);
	m_CMapMask.AddMap("binglang2", 303, 303);
	m_CMapMask.AddMap("chaosicicle", 303, 303);
	m_CMapMask.AddMap("darkswamp", 542, 1494);
	m_CMapMask.AddMap("garner2", 279, 279);
	m_CMapMask.AddMap("garner3", 279, 279);
	m_CMapMask.AddMap("guildhouse", 255, 255);
	m_CMapMask.AddMap("guildwar", 623, 623);
	m_CMapMask.AddMap("heilong", 1022, 1022);
	m_CMapMask.AddMap("hell", 255, 255);
	m_CMapMask.AddMap("hell2", 279, 199);
	m_CMapMask.AddMap("hell3", 383, 383);
	m_CMapMask.AddMap("hell4", 127, 127);
	m_CMapMask.AddMap("hell5", 255, 215);
	m_CMapMask.AddMap("jialebi", 1838, 1438);
	m_CMapMask.AddMap("kyjj_1", 127, 127);
	m_CMapMask.AddMap("kyjj_2", 127, 127);
	m_CMapMask.AddMap("kyjj_3", 127, 127);
	m_CMapMask.AddMap("L4MAP", 255, 511);
	m_CMapMask.AddMap("leiting2", 335, 335);
	m_CMapMask.AddMap("mingyun", 127, 127);
	m_CMapMask.AddMap("mjing1", 455, 575);
	m_CMapMask.AddMap("mjing2", 455, 575);
	m_CMapMask.AddMap("mjing3", 455, 575);
	m_CMapMask.AddMap("mjing4", 455, 575);
	m_CMapMask.AddMap("PKmap", 127, 127);
	m_CMapMask.AddMap("puzzleworld", 543, 543);
	m_CMapMask.AddMap("puzzleworld2", 543, 543);
	m_CMapMask.AddMap("puzzleworld3", 543, 543);
	m_CMapMask.AddMap("puzzleworld4", 543, 543);
	m_CMapMask.AddMap("sdBoss", 1023, 511);
	m_CMapMask.AddMap("secretgarden", 479, 479);
	m_CMapMask.AddMap("shalan2", 303, 407);
	m_CMapMask.AddMap("starena1", 127, 127);
	m_CMapMask.AddMap("starena2", 127, 127);
	m_CMapMask.AddMap("starena3", 127, 127);
	m_CMapMask.AddMap("starena13", 127, 127);
	m_CMapMask.AddMap("starena14", 127, 127);
	m_CMapMask.AddMap("starena15", 127, 127);
	m_CMapMask.AddMap("starena23", 127, 127);
	m_CMapMask.AddMap("starena24", 127, 127);
	m_CMapMask.AddMap("starena25", 127, 127);
	m_CMapMask.AddMap("starena33", 127, 127);
	m_CMapMask.AddMap("starena34", 127, 127);
	m_CMapMask.AddMap("starena35", 127, 127);
	m_CMapMask.AddMap("starwalkway", 255, 511);
	m_CMapMask.AddMap("teampk", 95, 95);
	m_CMapMask.AddMap("yschurch", 511, 511);
