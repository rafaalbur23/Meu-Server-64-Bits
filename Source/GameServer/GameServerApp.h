...
public:
    ...
    bool AddPlayer(GatePlayer* gtplayer, GateServer* gt, unsigned long long gtaddr);
...
inline void uplayer::Init(char const* gt_name, unsigned long long gt_addr, DWORD cha_id)
{
