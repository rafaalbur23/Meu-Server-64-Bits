...
CFixList::CFixList(CForm& frmOwn) :
	CCompent(frmOwn), _nRowHeight(22), _nRowSpace(0), _pImage(NULL), _pSelect(NULL), _nLeftMargin(5), _nTopMargin(5), _nRightMargin(5), _nBottomMargin(5), evtSelectChange(NULL), evtListMouseDown(NULL)
{
