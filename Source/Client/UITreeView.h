...
{
  public:
  CTreeSelectItem(CTreeView* own) :
	  _pOwn(own), _pItem(NULL), _pParent(NULL) {}
...
{
  public:
  CTreeNodeObj(CTreeView* own) :
	  _pOwn(own), _IsExpand(true), _pParent(NULL), _dwTag(0) { _nodes.push_back(this); }
...
{
  public:
  CTreeNode(CTreeView* own, CItemObj* item) :
