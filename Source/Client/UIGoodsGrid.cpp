...
CGoodsGrid::CGoodsGrid(CForm& frmOwn) :
	CCommandCompent(frmOwn), _nLeftMargin(0), _nTopMargin(0), _nRightMargin(0), _nBottomMargin(0), _nUnitHeight(32), _nUnitWidth(32), _nSpaceX(2), _nSpaceY(2), _nRow(0), _nCol(0), _nMaxNum(0), _pItems(NULL), _nFirst(0), _nLast(0), _nTmpIndex(0), _eShowStyle(enumSmall), evtThrowItem(NULL), evtSwapItem(NULL), evtUseCommand(NULL), evtBeforeAccept(NULL), evtRMouseEvent(NULL), _nCurNum(0), _IsShowHint(true)
{
