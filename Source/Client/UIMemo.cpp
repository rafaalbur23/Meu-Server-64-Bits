...
CMemo::CMemo(CForm& frmOwn) :
	CCompent(frmOwn), _IsTextCenter(true), _color(0xff000000), _nItemRowNum(0), _nMisRowNum(0), evtSelectChange(NULL), _nMaxNum(40), _nRowNum(0), _nFirst(0), _nLast(0), _nPageShowNum(4), _bIsHaveItem(false), _bIsHaveMis(false), _nLeftMargin(0), _nTopMargin(4), _nRightMargin(4), _nBottomMargin(4), _nRowHeight(20), _nSelectItem(-1), _nSelectMis(-1), _nMemoNum(0)
{
  int i = 0;
...
void CMemo::ProcessCaption()
{
  ...
  { // modify by ning.yan 20081006 NPC对话框断字处理 begin
	icu::UnicodeString str = _strCaption.c_str();
	...
	{
	  icu::UnicodeString string(str, lineStarts[_nRowNum], lineEnds[_nRowNum] - lineStarts[_nRowNum]);
...
CMemoEx::CMemoEx(CForm& frmOwn) :
	CCompent(frmOwn), _color(0xff000000), evtSelectChange(NULL), _nMaxNum(-1), _nRowNum(0), _nFirst(0), _nLast(0), _nPageShowNum(4), _nLeftMargin(0), _nTopMargin(4), _nRightMargin(4), _nBottomMargin(4),
