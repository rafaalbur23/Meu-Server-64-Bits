...
CSelectItem::CSelectItem() :
	_pItem(NULL), _isSelect(false), _nIndex(-1), _isEnabled(true), _pList(NULL)
{
  _pImage = new CGuiPic;
}
...
CListItems::CListItems() :
	_pSelect(new CSelectItem()), _dwCount(0), _nItemLeft(0), _nItemTop(0), _dwFirstShowRow(0), _pList(NULL), _dwLastShowRow(0), _nShowCount(1000), _nMaxRow(0), _IsMouseFollow(false), _pItemPic(NULL), _nPicLeft(0), _nPicTop(0), _nPicX(0)
{
}
...
CList::CList(CForm& frmOwn) :
	CCompent(frmOwn), _nRowHeight(22), _nSpaceBottom(0), _dwFontColor(COLOR_BLACK), _dwSelectColor(0xFF00FF71), _nLeftMargin(5), _nTopMargin(5), _nRightMargin(5), _nBottomMargin(5), _IsChangeColor(true), evtSelectChange(NULL), evtListMouseDown(NULL), evtListMouseDB(NULL)
{
  _IsFocus = false;
