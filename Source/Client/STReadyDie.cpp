...
CReadyDieState::CReadyDieState(CActor* p) :
	CActionState(p), _state(enumDied), _IsActionEnd(false), _eDieState(enumInit), _nFallDownTime(0), _IsAlreadyEffect(false), _pAttack(NULL), _pArcTrack(NULL), _isFlyOff(false)
{
