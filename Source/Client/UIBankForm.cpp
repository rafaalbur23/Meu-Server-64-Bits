...
#define BANK_TYPE  1
  ...
  if(pkItemRecord->lID == 2520 || pkItemRecord->lID == 2521 || pkItemRecord->lID == 6341 || pkItemRecord->lID == 6343 || pkItemRecord->lID == 6347 || pkItemRecord->lID == 6359 || pkItemRecord->lID == 6370 || pkItemRecord->lID == 6371 || pkItemRecord->lID == 6373 || pkItemRecord->lID >= 6376 && pkItemRecord->lID <= 6378 || pkItemRecord->lID == 6611 || pkItemRecord->lID >= 6383 && pkItemRecord->lID <= 6385 || pkItemRecord->lID >= 6473 && pkItemRecord->lID <= 6479 || pkItemRecord->lID == 6868 || pkItemRecord->lID == 6869 || pkItemRecord->lID == 6901 || pkItemRecord->lID == 6959)
