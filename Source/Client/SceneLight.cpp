...
int AnimCtrlLight::UpdateObject(SceneLight* ret_obj)
{
  ...
  ret_obj->type = u->type;
  LEVector3Slerp((MPVector3*)&ret_obj->pos, (MPVector3*)&u->pos, (MPVector3*)&v->pos, t);
  LEVector3Slerp((MPVector3*)&ret_obj->amb.r, (MPVector3*)&u->amb.r, (MPVector3*)&v->amb.r, t);
  LEVector3Slerp((MPVector3*)&ret_obj->dif.r, (MPVector3*)&u->dif.r, (MPVector3*)&v->dif.r, t);
