...
UIRender::UIRender() :
	_nGuiWidth(1280), _nGuiHeight(720), _fScreenScaleX(1.0), _fScreenScaleY(1.0), _fDrawScaleX(1.0), _fDrawScaleY(1.0), _p2DSprite(NULL), _nTex(-1)
{
  _rtFrame.left	  = 0;
  _rtFrame.top	  = 0;
  _rtFrame.right  = 1;
...
void UIRender::SetScreen(int w, int h, bool isFull)
{
  ...
  _fDrawScaleX = (float)((float)w / 1280.0);
  _fDrawScaleY = (float)((float)h / 720.0);
