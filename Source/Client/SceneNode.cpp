...
CSceneNode::CSceneNode() :
	_dwID(0), _dwTypeID(0), _dwAttachID(0), _dwFrameCnt(0), _dwRenderCnt(0), _bValid(0), _nCurX(0), _nCurY(0), _nYaw(0), _nPitch(0), _nRoll(0), _bHide(0), _pScene(NULL), _nHeightOff(0), _nPoseHeightOff(0), _nSize(0), lTag(0)
{
  _iEffNum = 0;
