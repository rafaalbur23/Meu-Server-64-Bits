...
CGrid::CGrid(CForm& frmOwn) :
	CCompent(frmOwn), _pImage(NULL), _nUnitHeight(32), _nUnitWidth(32), _nFirst(0), _nLast(0), _nColNum(0), _nMaxPage(0), _nPage(0), _nMargin(5), _nPageNum(0), _nSize(0), _pSelect(NULL), _nSpaceX(2), _nSpaceY(2), _pSelectImage(NULL), evtSelectChange(NULL), _clPageTextColor(0xff0000ff), _nSelectIndex(-1)
{
  // _IsFocus = true;
