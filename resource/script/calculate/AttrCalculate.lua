...
--Attributes Growth Rate of Cleric Class
		...
		Mxsp_sta_rad1[JOB_TYPE_SHENGZHIZHE], Mxsp_sta_rad2[JOB_TYPE_SHENGZHIZHE], Mxsp_lv_rad[JOB_TYPE_SHENGZHIZHE] = 3, 2.5, 5								--最大sp的属性影响系数：精力系数、体质系数、等级系数
...
------------------------------------------------------
	...
	if ret == LUA_TRUE then
		...
		if lv == 10 then				--10级奖励
			...
			--给师傅的奖励
			AddMasterCredit(role, 30)		--给师傅300点声望补偿值
			...
			--给师傅的奖励
			AddMasterCredit(role, 80)		--给师傅800点声望补偿值
...
function ExAttrSet(role) --[[赋值扩展属性]]--
    ...
    -- Definindo o valor inicial de 700 de movement speed
    local mspd_initial = 120
    
    -- Calculando o movement speed final com base no valor inicial e o cálculo da fun??o Mspd_final(role)
    local mspd_final = mspd_initial + Mspd_final(role) --[[计算最终mspd]]--
    
    -- Atribuindo o valor final de movement speed ao personagem
    SetCharaAttr(mspd_final, role, ATTR_MSPD ) --[[赋值最终最终mspd]]--

    -- Outros atributos calculados aqui...
end 
