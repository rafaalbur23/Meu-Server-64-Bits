...
function init_entry(map)
    ...
    SetMapEntryTime(map, "2006/10/19/13/0", "0/6/0", "0/0/30", "0/0/45")	-- The first set of numbers is the starting point (Year/Month/Day/Hour/Minute), next is opening interval (Day/Hour/Minute), portal open duration (Day/Hour/Minute), and last is the map duration (Day/Hour/Minute)
